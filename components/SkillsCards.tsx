...
const services = [
  ...
  },
  {
    ...
    icon: (
      <FaMobileAlt className="text-1xl sm:text-2xl lg:text-3xl text-white" />
    ),
...
const SkillsCards = () => {
  return (<motion.div 
    ...
    transition={{ duration: 0.8, ease: "easeOut" }}  className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 lg:gap-3 sm:gap-1 gap-1 sm:px-6 lg:px-6 px-1 sm:py-4 py-2 lg:py-4">
    {services.map((service, index) => (
      ...
      >
        {/* Icon Wrapper - Adjusted to Avoid Cutoff */}
