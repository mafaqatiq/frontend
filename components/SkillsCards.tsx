  ...
  return (
    ...
    >
      {services.map((service, index) => (
        <div
          key={index}
          className={`relative bg-[#F8F9FA] dark:hover:bg-[#353434]  dark:bg-[#373737] dark:text-white rounded-lg lg:p-5 sm:p-6 p-3 flex flex-row sm:flex-col lg:flex-col items-center sm:items-start lg:items-start transition-all duration-300 hover:shadow-xl  hover:bg-gradient-to-r group ${service.glow}`}
        >
