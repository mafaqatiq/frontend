...
const HireMeSection = () => {
  ...
  <div className="flex flex-col md:flex-row w-full gap-4 p-1 mt-4 mb-4">
    ...
    >
      <div className="flex flex-col items-center justify-center lg:ml-6 sm:ml-8 text-center">
        {/* Centered "Get In Touch" text for all screens */}
        <h1 className="my-2 text-2xl sm:text-4xl lg:text-5xl font-bold text-center">
          Get In Touch
        </h1>
        <p className="hidden lg:block lg:text-base lg:mb-3 sm:mb-3 text-sm text-[#7c7c7c] dark:text-[#b5b5b5] max-w-2xl mx-auto">
          Need a developer to turn your vision into reality? <br></br> Let’s connect and bring your project to life.
        </p>
        {/* Social Media Icons */}
    ...
    <motion.div
      ...
      animate={{ opacity: 1, x: 0 }}
      transition={{ duration: 0.8, ease: "easeOut" }}
      className="flex-1 flex justify-center items-center mx-2 sm:mr-6 lg:mr-6 text-sm lg:text-base sm:mt-6 lg:mt-0"
    >
