    ...
    <div ref={ref} className="flex flex-wrap   gap-3 w-full max-w-6xl mx-auto py-4">
      {stats.map((item, idx) => (
        <motion.div
          ...
          viewport={{ once: true }}
          className="w-32 h-32 flex pt-2 pb-2 flex-col justify-around items-center bg-white hover:bg-[#fdfdfd] dark:hover:bg-[#353434] dark:bg-[#373737] rounded-lg border-b-[10px] border-green-700 text-white shadow-lg text-center"
        >
